...
// Name: Kendall Won
// Date: 4/27/22
// Title: Lab 5 - Stop and Wait reliable protocol on top of UDP to provide a reliable transport service
// Description: The program below is UDP client with packets that have checksum, sequence number, and ACK number
...
int main(int argc, char *argv[]) {
    ...
    if((sockfd = socket(AF_INET, SOCK_DGRAM, 0)) < 0) {
        ...
        printf("Successful setup of endpoint socket\n", );
    }
